...
desc.Text = "Halo pengguna webhook, saat ini yui-webhook pindah alamat script. serta pembaharuan maintenance berkala.. silahkan gunakan script dibawah ini dan dikonfigurasi ulang ya:"
